    ...
    <div className='grid grid-cols-4 gap-5'>
      <div className='col-span-3'>
          ...
          <div className='grid grid-cols-2 mt-6 gap-6'>
            <div className='rounded-2xl bg-white py-4 pr-8 shadow-md'>
            ...
            <div className='rounded-2xl bg-white py-4 pr-8 shadow-md px-6'>
          ...
          <div className='mt-6 bg-white rounded-2xl py-4 pl-2 pr-8 shadow-md'>
              <div className='flex justify-between items-center'>
                <h2 className='font-bold text-xl pl-8'>Patient Statistics</h2>
                <select name="" id="" className='text-sm text-gray-500 border-2 border-gray-200 rounded-lg py-2 px-2'>
      ...
      <div>
        ...
        <div className='mt-5 space-y-3'>
          ...
          <div className='mt-5 pl-6 pr-4 py-4 bg-white rounded-2xl shadow-sm'>
